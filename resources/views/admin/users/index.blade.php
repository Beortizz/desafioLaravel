...
<tr>
    ...
    <td class=" options">
        ...
        <a href="{{ route('users.edit', $user->id) }}" title="Editar Usuário" class="btn btn-sm btn-success"><svg
        ...
        <a href="{{ route('users.show', $user->id) }}" title="Visualizar Usuário" class="btn btn-sm btn-primary"><svg
        ...
        <form class="form-delete" action="{{ route('users.destroy', $user->id) }}" method="post">
            ...
            <button type="submit" title="Excluir Usuário" class="btn btn-sm btn-danger"><svg
