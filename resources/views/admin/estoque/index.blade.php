...
{{-- @dd(route('estoque.addProduto', $info->id)) --}}
<tr>
    {{-- @dd($info->produtos()) --}}
    <td>
       {{-- @if(is_array($info->produtos))  --}}
    ...
    <td class=" options">
        @can('isAdm')
        {{-- @dd(route('estoque.addProduto', $info->id)) --}}
        {{-- <a href="{{ route('estoque.addProduto', $info->id) }}" title="Editar estoque" class="btn btn-sm btn-success"><svg
