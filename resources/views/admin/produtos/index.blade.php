...
<tr>
    ...
    <td class="options">
        @can('update', $produto)
        <a href="{{ route('produtos.edit', $produto->id) }}" title="Editar produtos" class="btn btn-sm btn-success"><svg
        ...
        @endcan  
        <a href="{{ route('produtos.show', $produto->id) }}" title="Visualizar produtos"
